...
import 'package:industry/style/CustomTextStyle.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
              margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
              child: Text(
                "When you invite friends to join Mkwasi Industry, you can 100 points to each friends.Whenever your friends consume through Mkwasi Industry, you will get a 5% bonus",
                style: CustomTextStyle.textFormFieldBold
